...
class StatusDetailPage extends StatefulWidget
{
  String message;
  int index;
  StatusDetailPage(this.message, this.index);
  @override
  _StatusDetailPageState createState() => _StatusDetailPageState(message, index);
...
class _StatusDetailPageState extends State<StatusDetailPage>
{
  String message;
  int index;
  _StatusDetailPageState(this.message, this.index);
...
@override
  ...
  Widget build(BuildContext context) {
    // TODO: implement build
     return Scaffold(
        appBar: AppBar(title: Text("Status No. ${index+1}",
